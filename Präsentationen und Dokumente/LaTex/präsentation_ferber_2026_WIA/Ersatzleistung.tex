...
\setoverheader{Eigene Tätigkeit}

\begin{frame}
\frametitle{Persönliche Aufgaben}

\begin{itemize}
  \item Einsatz von LLMs für interne und externe Prozesse
  \item Schwerpunkte:
  \begin{itemize}
    \item Retrieval Augmented Generation
    \item Datenaufbereitung
    \item Lokale / interne LLMs
  \end{itemize}
\end{itemize}
\end{frame}
