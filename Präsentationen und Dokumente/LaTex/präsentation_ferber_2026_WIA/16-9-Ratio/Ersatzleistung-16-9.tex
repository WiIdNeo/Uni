...
% TITELINFOS
% ---------------------------------------------------------
\title[Vorstellung: Praxispartner und Tätigkeitsbereich]{Vorstellung: Praxispartner und Tätigkeitsbereich}
...
\begin{columns}[T]  % T = oben ausrichten
  ...
  \begin{column}{0.6\textwidth}
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item 3D-Modelle
      \end{itemize}
      \item Installation und Konfiguration \\der Software- und Serverinfrastruktur
  ...
  \hspace{-1.1cm}
  \begin{column}{0.4\textwidth}
    \includegraphics[width=\linewidth,height=0.7\textheight,keepaspectratio]{alvis-logo-100.png}
...
\begin{figure}
  \hspace{-2cm}
\begin{overpic}[width=0.7\textwidth]{objects_1.png}
    \put(50,17){\includegraphics[width=0.5\textwidth]{timeseries_2.png}}
\end{overpic}
\end{figure}
\end{frame}
...
\centering
    \includegraphics[width=0.7\textwidth,keepaspectratio]{CLIPSearch.png}%
\end{frame}
% ---------------------------------------------------------
% ABSCHLUSS
% ---------------------------------------------------------
